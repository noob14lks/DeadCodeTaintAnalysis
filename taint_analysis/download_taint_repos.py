...
DEST_DIR = os.path.join(PROJECT_ROOT, "taint_analysis", "dataset", "github_repos")
LABELS_PATH = os.path.join(PROJECT_ROOT, "taint_analysis", "labels.csv")

REPOSITORIES = {
    "django": "https://github.com/nVisium/django.nV",
